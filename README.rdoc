...
KermitPFC-core has got a Twitter implementation for default, to use it:

First, you must modify the config.example.yml file with your personal data (Redis connection, SocialNetwork credentials, trackwords, ...) and rename it with config.yml name.
...
Finally you only need to change permisions on kermit file 
